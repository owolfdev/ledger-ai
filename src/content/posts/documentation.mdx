export const metadata = {
  ...
  type: "blog",
  title: "📟 Ledger App — Terminal Command System",
  author: "O. Wolfson",
...
| File / Path                                  | Purpose                                                                                            |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `/commands/smart/add-command-handler.ts`     | Main orchestration for `add` terminal commands — handles both structured JSON and manual commands. |
...
- **Custom AI Rules**: Modify AI prompt in `/commands/smart/add-command-handler.ts`.
